...
\chapter{组内文献阅读}
%-------------------------------------------------------------------------------------------------
\section{Excretable IR-820 for in vivo NIR-II fluorescence cerebrovascular imaging}
\href{https://www.thno.org/v09p5706.htm}{出版商全文连接}。
\begin{introduction}[创新点概要]
  \item IR-820在血清中的NIR-II荧光产率高，稳定性好
  \item IR-820的光热效应显著
  \item IR-820脑血管成像，脑血流速度计算
  \item 脑血管功能成像：动脉栓塞模型
\end{introduction}
...
\subsection{文中提及的数据及知识点}
  ...
  \begin{enumerate}
    ...
    \item IR-820在10\%FBS中的吸收峰红移了大约160 nm，在约860 nm。NIR-II量子产率也更高，为2.521。
    \item IR-820光稳定性较好。$20mW/cm^2$照射60分钟亮度没有明显减弱。
    \item IR-820分子吸附在血清中的蛋白上，表现出纳米颗粒的特征。
    \item IR-820主要通过肝胆和肾脏代谢，注射10分钟就会富集在肝脏中。注射材料5周后，所有器官中的荧光信号全部消失。
    \item IR-820在体内肝脏、肾脏、膀胱有较强的荧光信号。
    \item 正常小鼠大脑中的血流速度为$0.2-20 × 10^3μm/s$。
    \item 光热治疗的实验采用皮下瘤裸鼠肌肉注射方式，48小时后肿瘤部位最亮，肿瘤靶向作用可能来源于EPR效应。$2W/cm^2$照射10分钟。
    \item IR-820购买自上海阿拉丁生化科技有限公司\footnote{2021/6/4日在阿拉丁网站上已经没有找到IR-820的相关信息了，最接近的有\href{https://www.aladdin-e.com/zh_cn/catalogsearch/result/?q=134127-48-3}{IR-813}。}。
  \end{enumerate}
...
\section{实验室信息}
浙江省杭州市西湖区余杭塘路866号浙江大学（紫金港校区）东5教学楼\;光及电磁波研究中心 
